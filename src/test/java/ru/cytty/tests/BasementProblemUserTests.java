...
@Feature("Тесты перехода на страницы соц.сетей на сайте https://www.saucedemo.com/ для проблемного пользователя")
@Story("Тесты перехода на страницы соц.сетей на сайте https://www.saucedemo.com/ для проблемного пользователя")
@Epic("Проблемный пользователь")
public class BasementProblemUserTests extends BaseTest {
    final static Logger logger = LoggerFactory.getLogger(BasementProblemUserTests.class);
    ...
    static void logout() {
        driver.quit();
        logger.info("Тесты перехода на страницы соц.сетей на сайте https://www.saucedemo.com/ для  проблемного пользователя завершены");
    }
}
