...
public class InventoryPagePerformanceUserTests extends BaseTest{
    final  static Logger logger = LoggerFactory.getLogger(InventoryPagePerformanceUserTests.class);
